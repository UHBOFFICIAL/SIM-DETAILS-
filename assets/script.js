...
searchBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    if (response.status === 402 || data.result === "If Data Not found. Please Contact Owner.") {
      showNotification("Paid ApiKey Required", "Using Free API Because You Didn't Have Paid ApiKey.", "error", 7000);
